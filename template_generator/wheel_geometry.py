...
class WheelTemplate(object):
    ...
    def check_errors_in_geometry(self):
        ...
        elif not (self.hub_inner_radius + self.lug_nut_radius <= self.bolt_circle_radius <= self.hub_radius - self.lug_nut_radius):
    ...
    def calc_areas(self):
        ...
        assert self._floats_equal(solid_coverage, rim_coverage + hub_coverage + spokes_coverage), "internal geometric error1"
        assert self._floats_equal(solid_area + rim_deadzone_area - spokes_area + lug_nuts_area + center_bore_area, wheel_area), "internal geometric error2"
